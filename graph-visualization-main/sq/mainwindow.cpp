    ...
    , ui(new Ui::MainWindow)
{
    ...
    //this->resize(640,640);          // Устанавливаем размеры окна приложения
        ...
        connect(ui->graphicsView, SIGNAL(customContextMenuRequested(QPoint)), SLOT(showContextMenu(QPoint)));
}
...
void MainWindow::on_actionsome_triggered(bool checked)
{
    ui->statusbar->showMessage("Кнопка для взаимодействия с полем!");
}
...
void MainWindow::showContextMenu(const QPoint &pos)
{
        ...
        QAction* editDevice = new QAction(tr("Сюда перенести редактирование"), this);
        QAction* deleteDevice = new QAction(tr("Сюда перенести удаление"), this);
